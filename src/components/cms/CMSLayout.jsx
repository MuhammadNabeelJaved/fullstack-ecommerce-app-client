                    ...
                    >
                      <div
                        className={`flex-shrink-0 w-2 h-2 mt-2 rounded-full ${
                          notification.read ? "invisible" : "bg-indigo-500"
                        } mr-3`}
                      ></div>
          ...
          >
            ...
            <div className="flex flex-col h-[calc(100vh-4rem)]">
              ...
              <div className="mt-auto p-3 border-t">
                ...
                >
                  <span
                    className={`${isSidebarOpen ? "mr-3" : ""} relative group`}
                  >
                    <LogOut size={20} />
                    {!isSidebarOpen && (
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative group">
                  ...
                  <div
                    className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 ${
                      isDarkMode
                        ? "bg-gray-800 border border-gray-700"
                        : "bg-white border border-gray-200"
                    } z-50`}
