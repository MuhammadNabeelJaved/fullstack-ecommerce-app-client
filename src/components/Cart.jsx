...
import apiService from "../apis/fetchApis";
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center mt-4 sm:mt-0 sm:ml-6">
                      ...
                      >
                        <span className="text-xl font-medium w-5 h-5 flex items-center justify-center text-gray-700">
                          -
                        </span>
                      </motion.button>
                      <span className="mx-4 font-medium px-3 py-1 bg-gray-50 rounded-md">
                        {item.quantity}
                      </span>
                      <motion.button
                        whileHover={{ scale: 1.1 }}
