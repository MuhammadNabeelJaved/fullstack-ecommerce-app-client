        ...
        <div className="max-w-lg px-8 relative z-10">
          ...
          >
            <div className="text-2xl font-light mb-2">
              The only way to do <span className="text-blue-500 font-medium">great work</span> is to
            </div>
            <div className="text-2xl font-light">
              <span className="text-blue-500 font-medium">love what you do</span>.
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              {password && (
                ...
                >
                  ...
                  <ul className="text-xs text-gray-500 space-y-1.5">
                    ...
                    <li className={`flex items-center ${/[^\w\s]/.test(password) ? 'text-green-600' : ''}`}>
                      {/[^\w\s]/.test(password) ? (
                        <RiCheckLine className="mr-1.5 text-green-600" />
                      ) : (
                        <span className="w-4 h-4 mr-1.5 flex items-center justify-center rounded-full border border-gray-300"></span>
            ...
            >
              <label htmlFor="agreeTerms" className="flex items-center">
                ...
                <span className="text-sm text-gray-700">
                  I agree to the <a href="#" className="text-blue-500">Terms and Conditions</a> and <a href="#" className="text-blue-500">Privacy Policy</a>
                </span>
              </label>
              {errors.agreeTerms && (
                <motion.p 
            ...
            >
              <button
                ...
                className="w-full px-4 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
              >
